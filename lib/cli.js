...
function doHelp() {
	...
	console.log( "%s -o|--organization <orgname> -u|--username <username|email> -d|--directory <output-directory> -c|--command <import|export> [-p|--password <password>] [-b|--baseurl <http://mgmt-server:port>] [-D|--debug] [-h|--help]", process.argv[1] );
	process.exit(1);
}
